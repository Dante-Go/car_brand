...
'''
labels_nums = gbl.labels_nums  # 类别个数
batch_size = gbl.batch_size  #
resize_height = gbl.resize_height  # mobilenet_v1.default_image_size 指定存储图片高度
resize_width = gbl.resize_width   # mobilenet_v1.default_image_size 指定存储图片宽度
depths = gbl.depths
...
#     train_record_file='/data/car_brand_model/data/record/train224.tfrecords'
#     val_record_file='/data/car_brand_model/data/record/val224.tfrecords'
    ...
    train_record_file = os.path.join(dataset_base_path, 'record', train_record_output)
    val_record_output = 'val{}.tfrecords'.format(resize_height)
    val_record_file = os.path.join(dataset_base_path, 'record', val_record_output)
...
#     snapshot_prefix='models/model.ckpt'
    snapshot_prefix = os.path.join(model_base_path, 'model.ckpt')
